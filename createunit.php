	...
	<div id="header">
		<table style="width:100%;height:60px;border:none;border-collapse:collapse;background:rgba(50,50,50,1.0);" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td onclick="location.href='./unitselector.php'" width="25%" nowrap><div class='mechselect_button_normal'><a href='./unitselector.php'>UNITS</a><br><span style='font-size:16px;'>Choose a unit to play</span></div></td>
