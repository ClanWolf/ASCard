...
<head>
	...
	<link rel="manifest" href="/ASCard/manifest.json">
	<link rel="stylesheet" href="/ASCard/styles.css" type="text/css" media="screen">
	<link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css">
	<link rel="icon" href="/ASCard/favicon.png" type="image/png">
	...
	<script type="text/javascript" src="/ASCard/scripts/cookies.js"></script>
	<script type="text/javascript" src="/ASCard/scripts/howler.min.js"></script>
	<script type="text/javascript" src="/ASCard/scripts/functions.js"></script>
</head>
...
<div id="header">
	<table style="width: 100%;" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td width="20%" nowrap><div class="mechselect_button_active">#1</div></td>
			<td width="20%" nowrap><div class="mechselect_button_normal">#2</div></td>
			<td width="20%" nowrap><div class="mechselect_button_normal">#3</div></td>
			<td width="20%" nowrap><div class="mechselect_button_normal">#4</div></td>
			<td width="20%" nowrap><div class="mechselect_button_normal">#5</div></td>
		</tr>
	</table>
</div>
					...
					<table width="100%">
						<tr>
							...
							<td nowrap width="60%" style="text-align: right;">
								...
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="H2" value="yes"/><span class="bigcheck-target"></span></label>
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="H3" value="yes"/><span class="bigcheck-target"></span></label>
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="H4" value="yes"/><span class="bigcheck-target"></span></label>
							</td>
					...
					<table width="100%">
						<tr>
							...
							<td nowrap width="55%" style="text-align: left;">
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_E_1" value="yes"/><span class="bigcheck-target"></span></label>
							</td>
						...
						<tr>
							...
							<td nowrap width="90%" style="text-align: left;">
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_FC_1" value="yes"/><span class="bigcheck-target"></span></label>
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_FC_2" value="yes"/><span class="bigcheck-target"></span></label>
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_FC_3" value="yes"/><span class="bigcheck-target"></span></label>
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_FC_4" value="yes"/><span class="bigcheck-target"></span></label>
							</td>
						...
						<tr>
							...
							<td nowrap width="55%" style="text-align: left;">
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_MP_1" value="yes"/><span class="bigcheck-target"></span></label>
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_MP_2" value="yes"/><span class="bigcheck-target"></span></label>
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_MP_3" value="yes"/><span class="bigcheck-target"></span></label>
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_MP_4" value="yes"/><span class="bigcheck-target"></span></label>
							</td>
						...
						<tr>
							...
							<td nowrap width="55%" style="text-align: left;">
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_W_1" value="yes"/><span class="bigcheck-target"></span></label>
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_W_2" value="yes"/><span class="bigcheck-target"></span></label>
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_W_3" value="yes"/><span class="bigcheck-target"></span></label>
								<label class="bigcheck"><input onchange="readCircles();" type="checkbox" class="bigcheck" name="CD_W_4" value="yes"/><span class="bigcheck-target"></span></label>
							</td>
