...
--
-- Table structure for table `asc_game_archive`
--

DROP TABLE IF EXISTS `asc_game_archive`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `asc_game_archive` (
...
CREATE TABLE `asc_player` (
  ...
  `password_god` char(60) NOT NULL DEFAULT '$2y$10$z3P1WITOeWVFPOunpYZ9p.s8IDC.43zrk2bgiCvPtvXVO0pkVuC9i',
  `password_phoenix` varchar(60) DEFAULT NULL,
  `admin` tinyint(4) NOT NULL DEFAULT 0,
  `godadmin` tinyint(1) NOT NULL DEFAULT 0,
  `image` varchar(100) NOT NULL,
  `factionid` int(11) DEFAULT NULL,
  `hostedgameid` int(11) NOT NULL DEFAULT 0,
  `gameid` int(11) NOT NULL DEFAULT 0,
  `teamid` int(11) NOT NULL DEFAULT 0 COMMENT 'Replace the OpFor mechanic',
  `commandid` int(11) DEFAULT NULL,
  ...
  `active_ingame` tinyint(1) NOT NULL DEFAULT 1,
  `last_unit_opened` varchar(255) NOT NULL DEFAULT '-',
...
--
-- Table structure for table `asc_unitsortorder`
--

DROP TABLE IF EXISTS `asc_unitsortorder`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `asc_unitsortorder` (
  `unitsortorderid` int(11) NOT NULL AUTO_INCREMENT,
  `unittype` varchar(100) DEFAULT NULL,
  `sortorder` varchar(100) DEFAULT NULL,
  `description` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`unitsortorderid`)
...
CREATE TABLE `asc_unitstatus` (
  `unitstatusid` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `heat_PREP` int(11) NOT NULL DEFAULT 0,
  `heat_PREP_ENGINEHIT` int(11) NOT NULL DEFAULT 0,
  ...
  UNIQUE KEY `mechstatusid` (`unitstatusid`)
...
CREATE TABLE `asc_unitstatus_archive` (
  `unitstatusarchiveid` int(11) NOT NULL AUTO_INCREMENT,
  `initial_status` tinyint(1) DEFAULT 0,
  `unitid` int(11) DEFAULT NULL,
  `playerid` int(11) DEFAULT NULL,
  `gameid` int(11) DEFAULT NULL,
  ...
  `mounted_on_unitid` int(11) DEFAULT 0,
  `Updated` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`unitstatusarchiveid`),
  UNIQUE KEY `asc_unitstatus_archive_unique` (`unitstatusarchiveid`)
...
-- Dump completed on 2025-06-21  0:40:12
