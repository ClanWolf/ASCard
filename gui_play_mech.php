...
<?php
	if ($movd==1) {
		if ($playable) {
			...
			echo "						</tr>\n";
			echo "						<div name='fireinfo' style='background-image:repeating-linear-gradient(45deg, white 0%, white 2%, cyan 2%, cyan 4%, white 4%);'>\n";
			echo "						<tr>\n";
			echo "							<td nowrap align='left' valign='top' class='datalabel' style='vertical-align:top;background-color:#ffff00;'>\n";
			echo "								<label class='bigcheck'><input onchange='changeMovementFlag($array_MECH_DBID[$chosenMechIndex], 5);' type='checkbox' class='bigcheck' name='WF_WEAPONSFIRED' value='yes'/><span class='bigcheck-target'></span></label>\n";
 			echo "							</td>\n";
 			echo "							<td nowrap colspan='3' align='left' class='datalabel' style='background-image:repeating-linear-gradient(45deg, white 0%, white 2%, cyan 2%, cyan 4%, white 4%);'>\n";
