...
<?php
	if ($movd==1) {
		if ($playable) {
			...
			echo "											<span id='SMinRoll'>y</span>\n";
			echo "										</td>\n";
			echo "										<td nowrap align='right' class='datalabel' width='16%' style='text-align:right;'>\n";
			echo "											M&nbsp;&nbsp;&nbsp;&nbsp;<span id='MDamage'>x</span>\n";
			echo "										</td>\n";
			echo "										<td nowrap align='right' class='datalabel' width='1%' style='text-align:center;'>\n";
			echo "											|\n";
			echo "										</td>\n";
			echo "										<td nowrap align='left' class='datalabel' width='16%' style='text-align:left;'>\n";
			echo "											<span id='MMinRoll'>y</span>\n";
			echo "										</td>\n";
			echo "										<td nowrap align='right' class='datalabel' width='16%' style='text-align:right;'>\n";
			echo "											L&nbsp;&nbsp;&nbsp;&nbsp;<span id='LDamage'>x</span>\n";
			echo "										</td>\n";
			echo "										<td nowrap align='right' class='datalabel' width='1%' style='text-align:center;'>\n";
			echo "											|\n";
			echo "										</td>\n";
			echo "										<td nowrap align='left' class='datalabel' width='16%' style='text-align:left;'>\n";
			echo "											<span id='LMinRoll'>y</span>\n";
			echo "										</td>\n";
			echo "									</tr>\n";
			echo "									<tr>\n";
