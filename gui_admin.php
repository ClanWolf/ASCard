...
<?php
	...
	if (!$playMode) {
		...
		if ($isAdmin) {
			...
			echo "				<td nowrap onclick=\"location.href='./gui_admin.php'\" width=".$buttonWidth." class='menu_button_active'><a href='./gui_admin.php'>ADMIN</a><br><span style='font-size:16px;'>Administration</span></td><td style='width:5px;'>&nbsp;</td>\n";
		}
	}
?>
