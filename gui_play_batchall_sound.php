	...
	<script>
		...
		function playBatchallSound() {
			if (sound_Batchall == null) {
				sound_Batchall = new Howl({ src: ['./audio/rp/batchall.mp3', './audio/rp/batchall.ogg'] });
			}
			// alert(sound_Batchall);
			sound_Batchall.play();
		}
	...
	<div id="header">
		<table style="width:100%;height:60px;border:none;border-collapse:collapse;background:rgba(50,50,50,1.0);" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td nowrap onclick="location.href='./gui_select_unit.php'" width="<?php echo $buttonWidth ?>"><div class='menu_button_normal'><a href='./gui_select_unit.php'>ROSTER</a><br><span style='font-size:16px;'>Choose a unit</span></div></td>
				<td style="width:5px;">&nbsp;</td>

<?php
	if ($playMode) {
		echo "				<td nowrap onclick=\"location.href='./gui_select_formation.php'\" width=".$buttonWidth."><div class='menu_button_active'><a href='./gui_select_formation.php'>CHALLENGE</a><br><span style='font-size:16px;'>Batchall & bidding</span></div></td><td style='width:5px;'>&nbsp;</td>\n";
	}
	if (!$playMode) {
...
?>
	...
	<table width=90% align="center">
		<tr>
			<td align="center" valign="middle"><img src="./images/player/malthus.png" height="150px">&nbsp;&nbsp;&nbsp;&nbsp;<img src="./images/audio-spectrum.gif" height="150px"></td>
		</tr>
	</table>
</body>
