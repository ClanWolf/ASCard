...
<?php
	...
	if (!$playMode) {
		...
		echo "				<td nowrap onclick=\"location.href='./gui_edit_game.php'\" width=".$buttonWidth."><div class='menu_button_active'><a href='./gui_edit_game.php'>GAME</a><br><span style='font-size:16px;'>Game settings</span></div></td><td style='width:5px;'>&nbsp;</td>\n";
		if ($isAdmin) {
		...
		<table class="options" cellspacing=4 cellpadding=4 border=0px>
			<tr>
				<td align="center" class='datalabel'>
					<p>Round successfully reset.<br><br>You are now in round:</p>
					<p style="font-family:'Pathway Gothic One',sans-serif,bold;font-size:75px;color:green;">1</p>
				</td>
			</tr>
		</table>
	</div>
