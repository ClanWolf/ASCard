<?php
	...
	// https://www.ascard.net/app/gui_show_unit.php?gid=25&fid=121&scid=2
...
//	$chosenUnitIndex = 2;
	...
	$gid = isset($_GET["gid"]) ? filter_var($_GET["gid"], FILTER_VALIDATE_INT) : 25;
	$formationid = isset($_GET["fid"]) ? filter_var($_GET["fid"], FILTER_VALIDATE_INT) : 121;
	$chosenUnitIndex = isset($_GET["cid"]) ? filter_var($_GET["cid"], FILTER_VALIDATE_INT) : 2;

	$fadeOutDuration  = 150;
	$scrollToView     = 1;

	$hideNotOwnedUnit       = 0;
	$showplayerdata_topleft = 1;
	$playMode               = 1;
	$showDistancesHexes     = 0;
...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=0.75, minimum-scale=0.75, maximum-scale=1.85, user-scalable=yes, viewport-fit=cover" />
...
<script>
	document.addEventListener('readystatechange', event => {
		...
		document.getElementById("topright").style.top = "0px";
		document.getElementById("pv").style.top = "7px";
		document.getElementById("unit_number").style.top = "10px";
		document.getElementById("topright_showbutton").style.top = "0px";
		document.getElementById("faction").style.top = "2px";
		document.getElementById("topleft").style.top = "2px";
		document.getElementById("pilotimage").style.top = "2px";
		document.getElementById("pilotrank").style.top = "55px";
