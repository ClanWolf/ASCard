...
?>
  ...
  <p><strong>Active Probe (PRB)</strong><br>
  ...
  <p><strong>Advanced Fire Control (AFC)</strong><br>
  ...
  <p><strong>Aerospace Transport (AT#)</strong><br>
  ...
  <p><strong>Amphibious (AMP)</strong><br>
  ...
  <p><strong>Angel ECM (AECM)</strong><br>
    An Angel ECM suite has all the advantages of a standard ECM suite. Angel ECM is treated as two standard ECM suites.
  </p>
  <p><strong>Anti-’Mech (AM)</strong><br>
    Infantry units with the Anti-’Mech (AM) special ability can make a special attack against any ground units, landed VTOLs and WiGEs, or grounded aerospace units with which they are in base-to-base contact. Anti-’Mech Infantry attacks are treated as a physical attack (see p. 42).
  </p>
  <p><strong>Anti-Missile System (AMS)</strong><br>
  ...
  <p><strong>Armored Components (ARM)</strong><br>
  ...
  <p><strong>Armored Motive Systems (ARS)</strong><br>
  ...
  <p><strong>Artillery (ARTX-#)</strong><br>
  ...
  <p><strong>Autocannon (AC#/#/#/#)</strong><br>
  ...
  <p><strong>BattleMech HarJel (BHJ)</strong><br>
  ...
  <p><strong>BattleMech Shield (SHLD)</strong><br>
  ...
  <p><strong>Bloodhound Active Probe (BH)</strong><br>
  ...
  <p>In addition to these standard features, the Bloodhound is also unaffected by standard and light ECM specials (ECM and LECM). Presently, only the Angel ECM (AECM) can overwhelm the sensing abilities of the Bloodhound.</p>
  ...
  <p>Each bomb a unit carries reduces its Thrust value by 1. (Battle armor units with bombs suffer no effects on their Move ratings.) A bomb-carrying unit’s card should list how many bombs the unit is carrying in the scenario, which must be equal to or less than the number this ability enables it to carry.</p>
  <p><strong>Bridgelayer (BRID)</strong><br>
  ...
  <p>All bridgelayer bridges automatically float on water, as they contain integral flotation devices by design. Bridges placed by a non-infantry unit with this ability have a CF of 18 and may support units of Size class 3. The bridge may be targeted as a building and will be destroyed once its CF is reduced to 0. A bridge reduced to 10 points or less may only support units up to Size 2. Bridges reduced to 5 or fewer points it may only support Size 1 units.</p>
  <p>If a unit that exceeds a bridge’s Size limit attempts to use it, the bridge immediately collapses once the unit moves onto it. All units on a bridge when it collapses will fall and suffer 1 point of damage per 3 inches (or fraction thereof) of difference between the starting level and destination level, rolling for critical hits as normal. If the unit falls into prohibited terrain as a result of a bridge collapse, it is destroyed.
  </p>
  <p><em>Infantry Bridgelayers:</em> Infantry with this ability may erect a bridge using gear and parts carried with them for the task, but may only do so once per scenario. Infantry bridgelayers require 2 turns to complete their bridges, which possess a starting CF of 8, and can support units up to Size 2.</p>
  <p><strong>Capital Weapons (CAP)</strong><br>
  ...
  <p><strong>Cargo Transport, Kilotons (CK#)</strong><br>
  ...
  <p><strong>Cargo Transport, Tons (CT#)</strong><br>
  ...
  <p><strong>Cellular Ammunition Storage Equipment (CASE)</strong><br>
  ...
  <p><strong>Cellular Ammunition Storage Equipment II (CASEII)</strong><br>
  ...
  <p><strong>Critical-Resistant (CR)</strong><br>
  ...
  <p><strong>Ejection Seat (ES)</strong><br>
  ...
  <p><strong>Engineering (ENG)</strong><br>
  ...
  <p>An area cleared by engineering units does not actually change its terrain type; the clearing action simply creates a narrow, clear path through it that units may use to pass through the terrain as if it is clear. (For further explanation, see Terrain Conversion, p. 104.)</p>
  <p><strong>Energy (ENE)</strong><br>
    A unit with this ability has little to no ammo to explode, and ignores Ammo Hit critical hits (see Ammo Hit, p. 18).
  </p>
  <p><strong>Environmental Sealing (SEAL)</strong><br>
  ...
  <p><strong>Firefighter (FF)</strong><br>
  ...
  <p><strong>Flight Deck (FD)</strong><br>
  ...
  <p><strong>Improved Narc Missile Beacon (iNARC#)</strong><br>
  ...
  <p><strong>Large (LG)</strong><br>
    Large units cover a 2” AoE template area. Large units block LOS.
  </p>
  <p><strong>Light Active Probe (LPRB)</strong><br>
  ...
  <p>Hostile ECM systems, including Angel ECM (AECM) and standard ECM (ECM) will overwhelm the light active probe’s abilities.</p>
  <p><strong>Light ECM (LECM)</strong><br>
    Light ECM functions identically to ECM, but with a reduced radius. Light ECM only creates an ECM bubble with a 2” radius.
  </p>
  <p><strong>Light Target Acquisition Gear (LTAG)</strong><br>
  ...
  <p><strong>Long-Range Missiles (LRM#/#/#/#)</strong><br>
  ...
  <p><strong>’Mech Transport (MT#)</strong><br>
  ...
  <p><strong>Mine Dispenser (MDS#)</strong><br>
  ...
  <p><strong>Minesweeper (MSW)</strong><br>
  ...
  <p><strong>Missile (MSL #/#/#/#)</strong><br>
  ...
  <p>Consult the Capital and Sub-Capital Weapons rules to resolve combat using these weapons (see pp. 86-87).</p>
  <p><strong>Mobile Headquarters (MHQ#)</strong><br>
  ...
  <p>Instead of their normal attack, Narc launchers may fire specialty ammo (see Alternate Munitions, p. 76). The numerical value of this ability indicates the number of extra Narc beacon attacks the unit can deliver in a single turn.</p>
  <p><strong>Omni (OMNI)</strong><br>
  ...
  <p><strong>Overheat Long (OVL)</strong><br>
  ...
  <p>For all other incoming missiles, 1 point of defensive damage will apply a +1 to-hit modifier to the missile’s attack roll, and reduce the incoming attack’s damage value by half (rounded down, to a minimum of 0 points). If 2 or more points of defensive damage are assigned to an incoming missile attack, the attack is eliminated entirely.</p>
  ...
  <p><strong>Rail (RAIL)</strong><br>
    A unit with the Rail special can only move along rails.
  </p>
  <p><strong>Reactive Armor (RCA)</strong><br>
  ...
  <p>Note that this damage reducing effect even covers general attacks by units that possess such abilities, so if a unit that can deliver 4 points of damage at Short range attacks a target with reactive armor, and the attacker has the SRM 2/2 special, the damage delivered is 3 points (4 points total – (2 ÷ 2) = 3).</p>
  ...
  <p><strong>Reflective Armor (RFA)</strong><br>
  ...
  <p>Remote Sensors can also reveal units (see Hidden Units, p. 102), unless they are affected by hostile ECM systems, including Angel ECM (AECM) and standard ECM (ECM), which will overwhelm their abilities.</p>
  <p><strong>Saw (SAW)</strong><br>
    A unit with this special ability may forego its attack to clear an area of woods (see Terrain Conversion, p. 104).
  </p>
  <p><strong>Searchlight (SRCH)</strong><br>
    Units equipped with a searchlight ignore the to-hit modifiers for combat in darkness (see Darkness, p. 92).
  </p>
  <p><strong>Short Range Missiles (SRM #/#)</strong><br>
  ...
  <p><strong>Small Craft Transport (ST#)</strong><br>
  ...
  <p><strong>Space Defense System (SDS-C #/#/#/#, SDS-CM #/#/#/#, SDS-SC #/#/#/#)</strong><br>
  ...
  <p>In the limited instances where these weapons may be used, consult the Capital and Sub-Capital Weapons rules (see pp. 86-87).</p>
  ...
  <p><strong>Stealth (STL)</strong><br>
  ...
  <p><strong>Sub-Capital (SCAP)</strong><br>
  ...
  <p><strong>Taser (MTAS# or BTAS#)</strong><br>
  ...
  <p>For BTAS special abilities, the # in this special represents the maximum number of Taser attacks the unit can make for the entire scenario.</p>
  <p>All Taser attacks are resolved separately, and may be made in addition to the unit’s normal weapon or physical attacks.</p>
  <p><strong>Torpedo (TOR#)</strong><br>
  ...
  <p><em>Movement:</em> When a ’Mech with TSM has a heat scale level of 1 or higher, it gains 2 inches of additional ground Move. If the heat scale is 1, the unit also ignores the loss of 2 inches from overheating, but the overheating effects on Move for heat levels of 2+ remain in effect. (Unlike units with Industrial TSM, units with this ability do not include its movement effects in their normal stats, because the ability is activated only by overheating.)</p>
  <p><em>Physical Attacks:</em> When an overheating unit delivers a successful standard- or melee-type physical attack, it adds 1 point to the damage delivered by the attack. Unlike Industrial TSM, this heat-activated version imposes no additional to-hit modifiers.</p>
  <p><strong>Turret (TUR#)</strong><br>
  ...
  <p>Weapon attacks made using the turret cannot be combined with any other special attack ability (such as IF, FLK, and so on). Some particularly large units—such as mobile structures and very large or super large vehicles—may feature multiple turrets. A unit with multiple turrets may use each turret individually to deliver its attacks (see Exceptionally Large Units, pp. 96-99).</p>
  <p><strong>Underwater Maneuvering Units (UMU)</strong><br>
    A unit with the UMU special ability uses the submersible movement rules when it is submerged in water instead of the normal underwater movement rules (see Submersible Movement, p. 31).
  </p>
  <p><strong>Watchdog (WAT)</strong><br>
    A unit with this special ability possesses the Watchdog Composite Electronic Warfare System. For purposes of  Alpha Strike, it is treated as if it has both the ECM and Light Active Probe (LPRB) special abilities. (Active probes are covered in greater detail in the Advanced Options chapter, see pp. 62-113.)
  </p>
</div>
