			...
			<td nowrap colspan='3' style="background: rgba(50,50,50,1.0); text-align: center; vertical-align: middle;">
				...
				<?php
					if (!$playMode) {
						...
						echo "	<td nowrap width='1%' style='color:#dcdcdc;' class='mechselect_button_normal' onclick='javascript:editGame(".$pid.");'>\n";
						echo "		&nbsp;&nbsp;&nbsp;Edit Game&nbsp;&nbsp;&nbsp;\n";
						echo "	</td>\n";
						echo "  <td style='width:5px;'>&nbsp;</td>\n";
...
//				$mechDetailString = $mechDetailString."						<img src='./images/ranks/".$factionidSelected."/".$pilotrank.".png' width='18px' height='18px'>";
				...
				if ($mechstatusimage != "images/DD_BA_04.png" && $mechstatusimage != "images/DD_BM_04.png") {
					if ($activebid == "1") {
