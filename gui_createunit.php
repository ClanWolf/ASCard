	...
	<div id="header">
		<table style="width:100%;height:60px;border:none;border-collapse:collapse;background:rgba(50,50,50,1.0);" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td nowrap onclick="location.href='./gui_createunit.php'" width="17%"><div class='mechselect_button_active'><a href='./gui_createunit.php'>ADD</a><br><span style='font-size:16px;'>Create a new unit</span></div></td>
